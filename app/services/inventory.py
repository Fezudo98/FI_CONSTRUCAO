...
def _get_or_create_balance(company_id, product_id, location_id, lot_id=None):
    balance = StockBalance.query.filter_by(
        company_id=company_id, product_id=product_id, location_id=location_id, lot_id=lot_id
    ).first()
    if balance is None:
...
def _record_movement(company_id, product, location_id, lot_id, kind, quantity, reference_type=None,
...
def receive_stock(company_id, product, location_id, quantity: Decimal, lot_id=None,
    ...
    _record_movement(
        company_id, product, location_id, lot_id, MOVEMENT_IN, quantity,
        reference_type, reference_id, note, user_id,
    )
    return balance


def withdraw_stock(company_id, product, location_id, quantity: Decimal, lot_id=None,
                    reference_type=None, reference_id=None, note=None, user_id=None,
...
def reserve_stock(company_id, product, location_id, quantity: Decimal, lot_id=None,
    ...
    _record_movement(
        company_id, product, location_id, lot_id, MOVEMENT_RESERVE, quantity,
        reference_type, reference_id, None, user_id,
    )
    return balance


def release_reservation(company_id, product, location_id, quantity: Decimal, lot_id=None,
                         reference_type=None, reference_id=None, user_id=None):
    ...
    _record_movement(
        company_id, product, location_id, lot_id, MOVEMENT_RELEASE, quantity,
        reference_type, reference_id, None, user_id,
    )
    return balance
...
def adjust_stock(company_id, product, location_id, new_quantity: Decimal, lot_id=None,
    ...
    _record_movement(
        company_id, product, location_id, lot_id, MOVEMENT_ADJUST, abs(diff),
